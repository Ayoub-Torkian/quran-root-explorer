...
C.para("The āyah takes several forms: an <b>evidentiary / power sign</b> handed to a messenger to authenticate him; "
       "the <b>standing sign</b> of the Book (§⑤); and — when the sign is denied — a <b>protective</b> or <b>punitive</b> "
       "event in which creation itself acts. Across all of them <b>the whole of creation, element and creature alike, "
       "is God's instrument</b> — <i>'to God belong the hosts (junūd) of the heavens and the earth'</i> (48:4·7; 74:31).")
C.para("<b>A · Evidentiary / power signs</b> — the created order bent to authenticate a prophet (direct signs):")
C.table(["Prophet", "The sign (Qurʾānic)", "Verse", "≈ era · external"], tight=False, rows=[
    ["Mūsā", "staff → serpent, radiant hand — 'nine signs' (تِسْعَ آيَاتٍ بَيِّنَاتٍ)", "17:101 · 27:12", "≈ 13th c. BCE?"],
    ["Ṣāliḥ", "the she-camel, itself named a sign — هَٰذِهِ نَاقَةُ اللَّهِ لَكُمْ آيَةً", "7:73 · 54:27", "Thamūd ≈ 1st mill. BCE"],
    ["ʿĪsā", "clay bird given life, healing the blind & leper, raising the dead — بِإِذْنِ اللَّهِ", "3:49 · 5:110", "≈ 1st c. CE"],
    ["Sulaymān", "the wind (a month each way); speech of birds; Bilqīs's throne brought from afar in an instant — قَبْلَ أَن يَرْتَدَّ إِلَيْكَ طَرْفُكَ", "27:16·40 · 34:12 · 21:81", "≈ 10th c. BCE"],
])
C.para("<b>B · Protective & punitive signs</b> — a different element (or creature) strikes when the sign is denied; and once, birds defend the Sanctuary (indirect signs):")
C.table(["People / event", "Instrument", "Mechanism (Qurʾānic)", "Verse", "≈ date · external"], tight=False, rows=[
    ["Aṣḥāb al-Fīl (the Elephant)", "birds + stones — protective", "طَيْرًا أَبَابِيلَ · بِحِجَارَةٍ مِّن سِجِّيل", "105:3–4", "≈ 570 CE"],
    ["Nūḥ's people", "water", "the flood / drowning — الطوفان · أغرقنا", "29:14 · 7:64", "prehistoric · undated"],
    ["ʿĀd", "wind", "howling wind — رِيحٌ صَرْصَرٌ عَاتِيَة", "69:6 · 54:19", "ancient S. Arabia"],
    ["Thamūd", "sky / earth", "the Cry · bolt · quake — الصَّيْحَة · الصَّاعِقَة · الرَّجْفَة", "11:67 · 41:17 · 7:78", "≈ 1st mill. BCE"],
    ["Pharaoh & his host", "sea", "drowned — أَغْرَقْنَاهُم فِي الْيَمّ", "7:136 · 10:90", "≈ 13th c. BCE?"],
    ["Qārūn", "earth", "swallowed — فَخَسَفْنَا بِهِ وَبِدَارِهِ الْأَرْض", "28:81", "≈ 13th c. BCE?"],
    ["Lūṭ's people", "sky + earth", "stones + overturning — سِجِّيل · عَالِيَهَا سَافِلَهَا", "11:82 · 15:74", "≈ early 2nd mill. BCE"],
    ["Madyan (Shuʿayb)", "sky / earth", "the Cry · the quake — الصَّيْحَة · الرَّجْفَة", "11:94 · 7:91", "2nd mill. BCE · undated"],
])
C.note("<b>The date column is external and uncertain — [REPORT], not [TEXT].</b> The Qurʾān gives <b>no dates</b>; "
       "'≈ era' is traditional/scholarly estimate only, often legendary and debated (esp. Nūḥ, ʿĀd), and must not be "
       "read as Qurʾānic. Likewise, tying a people to a specific site (Iram · al-Ḥijr · Sodom), the she-camel's "
       "emergence 'from the rock', and the Elephant's location at Mecca are traditional settings — <b>[REPORT]</b>. "
       "What the text asserts (<b>[TEXT]</b>) is the event and its instrument; the shared, measured signature is: "
       "<b>sudden / unawares</b> (وَهُمْ لَا يَشْعُرُونَ, 16:45), <b>total</b> (a whole qawm), and <b>timed</b> "
       "(لِكُلِّ أُمَّةٍ أَجَلٌ, 7:34).")
C.callout("The tools of the Maker — and why there is no punishment-sign today",
          ...
          "sky cries, stones fall, and <b>birds</b> defend — element and creature alike are <i>junūd</i> (hosts) of "
          "God (48:4). And the Qurʾān answers 'why not now?' — <b>وَمَا مَنَعَنَا أَن نُّرْسِلَ بِالْآيَاتِ إِلَّا أَن "
          ...
          "(تَخْوِيفًا, 17:59). The <b>pattern is unchanged</b> — فَلَن تَجِدَ لِسُنَّةِ اللَّهِ تَبْدِيلًا (35:43); "
          "only its <b>mode</b> for the last people differs. So we <i>do</i> still have the sign — as the Book and the "
