...
from state import get_corpus, hero, log_page, copy_table
...
for sd in res["seed"]:
    ...
    copy_table(["role", "ref", "sura", "ayah", "sura_name", "all_roots", "text"],
               [["seed", sd['ref'], sd['surah'], sd['ayah'], _name.get(sd['surah'], ""),
                 " ".join(sd['roots']), sd['text']]], label="📋 Copy as table")
