...
def render_grouped_nav():
    ...
    st.markdown(
        ...
        "font-size:14px!important;border-radius:6px!important;padding:3px 9px 3px 14px!important;"
        "border-left:4px solid #1D9E75!important;margin:2px 0 5px 0!important;line-height:1.3!important;"
